...
<div class="container">
    <div class="row mb-3">
        <div class="col-12 d-flex justify-content-center">
            <!--<img width="50" src="{{ asset('/images/favicon.png') }}" alt="Logo">-->
        </div>
    </div>
    <div class="row justify-content-center">
        <div class="col-md-5">
            ...
            <div class="card p-4 border-0 shadow-sm">
                <div class="card-body">
                    <form id="login" method="post" action="{{ url('/login') }}">
                        @csrf
                        <h1><i class="bi bi-people"> Login</i></h1>
            ...
            <p class="text-center text-white mt-5 lead">
                Developed By
                <a href="" class="font-weight-bold text-white">Ahmad Ghozali</a>
            </p>
        </div>
    </div>
</div>
